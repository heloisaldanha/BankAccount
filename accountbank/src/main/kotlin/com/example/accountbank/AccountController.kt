...
class AccountController(
    ...
    fun update(@PathVariable document : String, @RequestBody account: Account): ResponseEntity<Account>{
        ...
        val toSave = accountDBOptional.orElseThrow{RuntimeException("Account document $document not found!")}.copy(
    ...
    fun delete(@PathVariable document : String) = repository.findByDocument(document).ifPresent {
